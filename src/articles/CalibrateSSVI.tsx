...
export const articleCalibrateSSVI =  new Article("articles/calibrate-ssvi", "Calibrate Implied Volatility Surface (SSVI)", "", 1, "Tutorials", ["finance"], "2024-07-26")
const notebookComponent = parse(require('./CalibrateSSVI.html').default)
